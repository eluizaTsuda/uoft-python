def read_grades(gradefile):
    ...
    Read and return the list of gades in fhe gradefile.
    ...
    # Read the grades, accumulanting them into a list
...
def count_grade_ranges(grades):
    ...
    >>> count_grade_ranges([77.5, 37.5, 62.5, 72.5, 100.0, 55.0, 95.0, 82.5, 97.5, 57.5])
    [0,0,0,1,0,2,1,2,1,2,1)
    '''
