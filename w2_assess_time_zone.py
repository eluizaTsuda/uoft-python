...
def get_hours(seconds):
    ...
    (You should call to_24_hour_clock to convert
    the number of full hours to a time on a 24-hour clock.
    This means that the return value should be in
    the range 0 to 23, inclusive.)
...
def get_minutes(seconds):
    ...
    (This means that the return value should be in the
...
def get_seconds(seconds):
    ...
    as seen on a clock.
    This means that the return value should be in the range
    0 to 59, inclusive.)
...
def time_to_utc(utc_offset, time):
    ...
    0.0
    """
    return to_24_hour_clock((utc_offset - time) * -1)
